...
/// A stateful DeepFilterNet processor backed by WebAssembly.
class DeepFilterNet extends stub.DeepFilterNet {
  /// Creates a processor using the bundled DFN3 model.
  ///
  /// Call and await [initialize] first. Web does not support [modelPath].
  factory DeepFilterNet.create({String? modelPath, double attenLimitDb = 100}) {
    if (modelPath != null) {
  ...
  DeepFilterNet._(this._state, this.frameLength) : super.unsupported();
